<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        style="margin:auto;display:block;position: fixed; left: 50%;top: 50%;margin-left: -100px;margin-right:-100px;"
        width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
        <defs>
            <clipPath id="ldio-pa7t34dh1q-cp" x="0" y="0" width="100" height="100">
        ...
        <g clip-path="url(#ldio-pa7t34dh1q-cp)">
            <g>
